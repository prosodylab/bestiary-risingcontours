...
(Note that these plots are based on one annotator's decisions, and as you'll see, some of them are annotation errors...)  
...
## The utterances with the perceptual norming:
